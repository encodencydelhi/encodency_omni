...
import type { ApiEnvironment, ApiMonitoringConfig, ApiMonitoringSnapshot, ApiRequest, ApiService, ApiTimeRange } from "../data/observability-types";
...
function KpiGrid({ snapshot, range, serviceId }: { snapshot: ApiMonitoringSnapshot; range: ApiTimeRange; serviceId: string }) {
  const m = kpis(snapshot, range, serviceId);
