...
export function PostDetailModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 max-[768px]:p-3 max-[480px]:p-2"
      onClick={onClose}
    >
      <div
        className="relative flex h-auto max-h-[90vh] w-full max-w-[60%] min-w-[500px] overflow-hidden rounded-[12px] bg-white shadow-2xl max-[900px]:max-w-[80%] max-[900px]:min-w-0 max-[900px]:flex-col max-[900px]:max-h-[95vh] max-[900px]:overflow-y-auto max-[600px]:max-w-[95%] max-[600px]:min-w-0 max-[480px]:rounded-[10px]"
      ...
      >
        ...
        <button
          ...
          onClick={onClose}
          aria-label="Close"
          className="absolute right-[10px] top-[10px] z-50 grid h-[28px] w-[28px] place-items-center rounded-full bg-[#ef2029] text-white shadow-md transition-all hover:bg-[#d91922] hover:scale-105 max-[480px]:right-[8px] max-[480px]:top-[8px] max-[480px]:h-[24px] max-[480px]:w-[24px]"
        >
          <X size={14} strokeWidth={2.2} />
        </button>

        {/* Left — Platform Preview */}
        <div className="flex w-[45%] shrink-0 items-stretch justify-center overflow-y-auto bg-[#fafbfc] px-[12px] py-[12px] max-[900px]:w-full max-[900px]:px-[16px] max-[900px]:py-[14px] max-[480px]:px-[10px] max-[480px]:py-[10px]">
        ...
        <div className="min-w-0 flex-1 overflow-y-auto bg-white px-[20px] py-[18px] max-[900px]:px-[18px] max-[480px]:px-[12px] max-[480px]:py-[14px]">
          ...
          <div className="mb-[10px] flex items-start gap-[8px]">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="rounded-[8px] bg-[#f7f9fc] px-[10px] py-[8px] text-[10px] leading-[1.4] text-[#52617a]">
                ...
                <br />
                <span className="text-[#155fc2]">#CleanGanga2025 #BehindTheScenes</span>
              </div>
            </div>
          </div>
          ...
          <div className="mb-[10px] flex items-center gap-[8px]">
            ...
            <div>
              ...
              <p className="m-0 text-[10px] font-[450] text-[#52617a]">
                Apr 25, 2025 <span className="text-[#c5cbd4]">|</span> {event.time}
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-[8px]">
            <button
              type="button"
              className="flex h-[34px] flex-1 items-center justify-center gap-[6px] rounded-[8px] bg-[#ef2029] px-[14px] text-[11px] font-[700] text-white shadow-sm transition-all hover:bg-[#df1b24]"
            >
            ...
            <button
              type="button"
              className="flex h-[34px] flex-1 items-center justify-center gap-[6px] rounded-[8px] border border-[#dce3eb] bg-white px-[14px] text-[11px] font-[650] text-[#29354f] transition-all hover:bg-[#f8fafc]"
            >
