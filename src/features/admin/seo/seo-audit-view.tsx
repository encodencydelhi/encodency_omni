  ...
  return (
    <div className="grid grid-cols-12 gap-3">
      ...
      <div className="col-span-12 flex h-[236px] flex-col overflow-hidden rounded-sm border border-[#E1E7EF] bg-white p-4 shadow-[0_1px_4px_rgb(31_50_81/0.06)] lg:col-span-3">
        ...
        <button className="mt-2 w-full shrink-0 rounded-sm border border-[#DDE4ED] bg-white py-1.5 text-[9px] font-semibold text-[#172044] shadow-sm transition-colors hover:bg-gray-50">
          View Crawl Log →
        </button>
      </div>
    ...
    <div className="rounded-sm border border-[#E8EDF3] bg-white shadow-sm overflow-hidden min-h-[500px]">
      <div className="p-4 border-b border-[#E8EDF3] flex justify-between items-center bg-white">
        <div className="relative">
          ...
          <input type="text" placeholder="Search issues..." className="pl-9 pr-4 py-1.5 text-[12px] border border-[#E8EDF3] rounded-sm focus:outline-none focus:border-[#3b82f6] w-64 shadow-sm" />
        </div>
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-3 py-1.5 rounded-sm border border-[#E8EDF3] text-[12px] font-medium text-[#334155] hover:bg-gray-50 bg-white shadow-sm">
    ...
    <div className="rounded-sm border border-[#E8EDF3] bg-white shadow-sm overflow-hidden flex flex-col h-[600px]">
      <div className="p-4 border-b border-[#E8EDF3] flex justify-between items-center bg-white">
        <div className="relative w-[300px]">
          <Search className="size-4 absolute left-3 top-1/2 -translate-y-1/2 text-[#94a3b8]" />
          <input type="text" placeholder="Filter by URL path..." className="pl-9 pr-4 py-1.5 text-[12px] border border-[#E8EDF3] rounded-sm focus:outline-none focus:border-[#3b82f6] w-full shadow-sm" />
        </div>
      </div>
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-sm border border-[#E8EDF3] bg-white p-4 shadow-sm flex items-center gap-3">
        ...
        <button className="px-4 py-1.5 rounded-sm bg-[#101A3D] text-white text-[12px] font-medium shadow-sm hover:bg-[#1e293b] flex items-center gap-2">
          Analyze Page
        </button>
      </div>
          ...
          <div className="rounded-sm border border-[#E8EDF3] bg-white p-5 shadow-sm">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="p-3 bg-[#F8FAFD] border border-[#E8EDF3] rounded-sm text-[13px] text-[#101A3D] font-medium">
              ...
              <div>
                ...
                <div className="p-3 bg-[#fff5f5] border border-[#fecaca] rounded-sm text-[12px] text-[#ef4444]">
      ...
      <form className="p-6 space-y-6">
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <select className="w-full border border-[#DDE4ED] rounded-sm px-3 py-2 text-[12px] text-[#172044] focus:outline-none focus:border-[#3b82f6] shadow-sm bg-white">
          ...
          <div>
            ...
            <input type="number" defaultValue={1000} className="w-full border border-[#DDE4ED] rounded-sm px-3 py-2 text-[12px] text-[#172044] focus:outline-none focus:border-[#3b82f6] shadow-sm" />
          </div>
        </div>

        <div>
          <label className="block text-[12px] font-semibold text-[#172044] mb-1.5">Excluded URL Patterns</label>
          <textarea rows={3} defaultValue="/api/*&#10;/admin/*" className="w-full border border-[#DDE4ED] rounded-sm px-3 py-2 text-[12px] text-[#334155] font-mono focus:outline-none focus:border-[#3b82f6] shadow-sm resize-none"></textarea>
          <p className="text-[10px] text-[#64748b] mt-1.5">Paths to ignore during the crawl (One per line).</p>
        </div>

        <div className="pt-4 flex justify-end gap-3">
          <button type="button" className="px-4 py-2 rounded-sm border border-[#DDE4ED] bg-white text-[#475569] text-[12px] font-semibold hover:bg-gray-50 transition-colors shadow-sm">
            Cancel
          </button>
          <button type="button" className="px-4 py-2 rounded-sm bg-[#101A3D] text-white text-[12px] font-semibold hover:bg-[#1e293b] transition-colors shadow-sm">
            Save Settings
          </button>
        </div>
      </form>
