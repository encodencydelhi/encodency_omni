  ...
  return <div className="space-y-4 pb-10 text-[#172044]">
    <header className="flex flex-col justify-between gap-4 xl:flex-row xl:items-end">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button onClick={runAudit} className="flex h-9 items-center gap-1.5 rounded-md bg-[#E30613] px-4 text-[11px] font-semibold text-white shadow-sm hover:bg-[#C90510]"><RefreshCw className={cn("size-3.5", running && "animate-spin")}/>{running ? "Scanning..." : "Run New Audit"}</button>
