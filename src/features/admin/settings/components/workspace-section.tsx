    ...
    <div className="space-y-2">
      ...
      <section className="bg-white rounded-xl border border-[#E2E8F0] shadow-2xs p-2.5 space-y-2">
        <div className="flex items-center justify-between border-b border-[#F1F5F9] pb-2">
          ...
          <Link
            href="/admin/projects"
            className="text-[10.5px] font-bold text-[#2563EB] hover:underline flex items-center gap-1 shrink-0"
          >
            Manage Clients Directory <ExternalLink className="size-2.5" />
          </Link>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center justify-between p-2.5 rounded-lg bg-[#F8FAFC] border border-[#E2E8F0]">
            <div className="space-y-0.5 pr-4">
              <div className="text-[12px] font-semibold text-[#111C3A]">Remember Last Selected Client</div>
              <p className="text-[10px] text-[#64748B]">
          ...
          <div className="flex items-center justify-between p-2.5 rounded-lg bg-[#F8FAFC] border border-[#E2E8F0]">
            <div className="space-y-0.5 pr-4">
              <div className="text-[12px] font-semibold text-[#111C3A]">Reset Filters on Client Switch</div>
              <p className="text-[10px] text-[#64748B]">
          ...
          <div className="flex items-center justify-between p-2.5 rounded-lg bg-[#F8FAFC] border border-[#E2E8F0]">
            <div className="space-y-0.5 pr-4">
              <div className="text-[12px] font-semibold text-[#111C3A]">Remember Filters Per Client Account</div>
              <p className="text-[10px] text-[#64748B]">
          ...
          <div className="flex items-center justify-between p-2.5 rounded-lg bg-[#F8FAFC] border border-[#E2E8F0]">
            <div className="space-y-0.5 pr-4">
              <div className="text-[12px] font-semibold text-[#111C3A]">Clear Local Workspace Cache on Switch</div>
              <p className="text-[10px] text-[#64748B]">
