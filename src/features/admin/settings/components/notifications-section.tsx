    ...
    <div className="space-y-2">
      <section className="bg-white rounded-xl border border-[#E2E8F0] shadow-2xs p-2.5 space-y-2">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 border-b border-[#F1F5F9] pb-2">
          ...
          <div className="flex items-center gap-2 text-[10px] font-bold text-[#64748B] bg-[#F8FAFC] px-2 py-1 rounded-lg border border-[#E2E8F0]">
              ...
              <div key={cat.key} className="space-y-1.5">
                <div className="flex items-center justify-between px-1">
                  <div>
                    ...
                    <p className="text-[9.5px] text-[#64748B]">{cat.desc}</p>
                  </div>
                </div>

                {/* Table Header */}
                <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl overflow-hidden shadow-2xs">
                  <div className="grid grid-cols-12 px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-[#64748B] border-b border-[#E2E8F0] items-center">
                    ...
                    {categoryItems.map((item) => (
                      ...
                      >
                        <div className="col-span-12 md:col-span-6 min-w-0 pr-2">
                          <div className="text-[11.5px] font-semibold text-[#111C3A] leading-tight">
                            {item.title}
                          </div>
                          <p className="text-[9.5px] text-[#64748B] leading-snug mt-0.5 truncate">
                            {item.description}
                          </p>
                        </div>
                        ...
                        <div className="col-span-12 md:col-span-6 grid grid-cols-4 text-center items-center py-1 md:py-0 border-t md:border-t-0 border-[#F1F5F9]">
                          ...
                          <div className="flex flex-col md:flex-row items-center justify-center gap-1">
                            <span className="md:hidden text-[9px] text-slate-400 font-medium">In-App</span>
                            <Switch
                              checked={item.inApp}
                          ...
                          {/* Email */}
                          <div className="flex flex-col md:flex-row items-center justify-center gap-1">
                            <span className="md:hidden text-[9px] text-slate-400 font-medium">Email</span>
                            <Switch
                              checked={item.email}
                          ...
                          {/* WhatsApp */}
                          <div className="flex flex-col md:flex-row items-center justify-center gap-1">
                            <span className="md:hidden text-[9px] text-slate-400 font-medium">WhatsApp</span>
                            <Switch
                          ...
                          {/* Slack */}
                          <div className="flex flex-col md:flex-row items-center justify-center gap-1">
                            <span className="md:hidden text-[9px] text-slate-400 font-medium">Slack</span>
                            <Switch
                              checked={item.slack}
