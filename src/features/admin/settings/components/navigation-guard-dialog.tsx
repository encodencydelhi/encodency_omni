...
export function NavigationGuardDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-slate-900/50 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="w-full max-w-md bg-white rounded-2xl border border-[#E2E8F0] shadow-2xl p-3 space-y-2 animate-in zoom-in-95 duration-150">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#64748B]">You have modified settings that have not yet been saved.</p>
            </div>
          </div>
          <button
            type="button"
        ...
        <p className="text-[11.5px] text-[#334155] leading-relaxed bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl p-2.5">
          If you switch sections without saving, your current modifications will be reverted. Would you like to save before navigating or discard them?
        </p>
        ...
        <div className="flex items-center justify-end gap-2 pt-1">
          <button
            ...
            onClick={onStay}
            disabled={isSaving}
            className="px-3.5 py-2 rounded-lg border border-[#E2E8F0] text-[11.5px] font-semibold text-[#475569] hover:bg-slate-50 transition-colors cursor-pointer disabled:opacity-50"
          >
            Stay Here
          </button>
          <button
