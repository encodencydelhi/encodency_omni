    ...
    >
            ...
            {[
              ...
              return (
                <li key={name} className="flex items-center gap-2">
                  ...
                  <i className="shrink-0 rounded-sm bg-[#DDF8EA] px-2 py-1 text-[9.5px] font-semibold not-italic text-[#078359]">
                    Ready
                  </i>
                </li>
              );
      ...
      <div className="mt-2.5 grid gap-2.5 xl:grid-cols-[.85fr_1.45fr_.85fr]">
        ...
        <div className="space-y-2.5">
          ...
          <div className="rounded-sm border border-[#CDECE1] bg-[#F1FCF7] p-3">
            <div className="flex items-start gap-2">
              <span className="grid size-7 place-items-center rounded-sm bg-[#0AA673] text-white">
              ...
              <span className="rounded-sm bg-[#DDF8EA] px-2 py-1 text-[9px] font-semibold text-[#078359]">Approved</span>
            </div>
            <div className="mt-2 flex items-center gap-1.5 text-[9.5px] text-[#526385]">
              <span>Approved by</span>
              <span className="grid size-5 place-items-center rounded-sm bg-[#111827] text-[8px] font-semibold text-white">MS</span>
              <b>Manish Sirohi</b>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-sm border border-[#CDECE1] bg-[#F7FDFA] p-3">
          ...
          <div className="grid gap-2 sm:grid-cols-3">
            {[
              ...
              <div
                key={key}
                className="flex items-center justify-between gap-2 rounded-sm border border-[#CDECE1] bg-white px-2.5 py-2"
              >
        ...
        <Card icon={CalendarDays} title="Launch Settings">
          {[
            ...
            >
              <span
                className={cn(
                  "mt-px grid size-3.5 shrink-0 place-items-center rounded-sm border-[1.5px]",
