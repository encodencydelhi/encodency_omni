          ...
          <section className="rounded-xl border bg-white shadow-sm overflow-hidden">
            ...
            <div className="flex flex-wrap items-center justify-between border-b p-3 bg-white">
              <div className="flex items-center gap-2">
                ...
                <button className="h-9 rounded-md border px-4 text-[12px] font-semibold shadow-sm hover:bg-gray-50 text-gray-700 transition-colors">Today</button>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="flex h-9 items-center gap-1.5 rounded-md border px-3 text-[12px] font-semibold shadow-sm hover:bg-gray-50 text-gray-700 transition-colors">
