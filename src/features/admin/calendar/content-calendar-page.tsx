               ...
               <section className="rounded-xl border bg-white shadow-sm overflow-hidden">
                  ...
                  <div className="flex flex-wrap items-center justify-between border-b p-3 bg-white">
                     <div className="flex items-center gap-2">
                        ...
                        <button className="h-9 rounded-sm border px-4 text-[12px] font-semibold shadow-sm hover:bg-gray-50 text-gray-700 transition-colors">Today</button>
                     </div>

                     <div className="flex items-center gap-2 cursor-pointer hover:opacity-80">
                        <h2 className="text-[15px] font-semibold text-foreground">September 2026</h2>
                     ...
                     <div className="flex items-center gap-3">
                        <div className="flex rounded-sm bg-gray-100 p-0.5 h-9">
                           {(["Month", "Week", "List"] as const).map((item) => (
                              <button
                                 ...
                                 className={cn(
                                    "rounded-sm px-4 text-[12px] font-semibold transition-all",
                        ...
                        <button className="flex h-9 items-center gap-1.5 rounded-sm border px-3 text-[12px] font-semibold shadow-sm hover:bg-gray-50 text-gray-700 transition-colors">
                     ...
                     {days.map((day, index) => {
                        ...
                        return (
                           <div key={index} className={cn("min-h-[90px] border-b border-r p-1.5 relative group transition-colors", isToday ? "bg-red-50/20" : "hover:bg-gray-50/50")}>
                              {/* Day Number */}
                              <div className={cn("text-[11px] font-semibold mb-1 ml-1", day <= 0 || day > 30 ? "text-gray-400" : "text-gray-700", isToday && "text-[#EB0711]")}>
                                 ...
                                 {events.map((item) => (
                                    <div key={item.id} className="rounded border bg-white px-1.5 py-1 flex items-start gap-1.5 shadow-sm group/event hover:border-blue-300 cursor-pointer transition-colors relative overflow-hidden">
                                       ...
                                       <div className="min-w-0 flex-1">
                                          <p className="truncate text-[10px] font-semibold text-gray-900 leading-tight">{item.title}</p>
                        ...
                        <table className="w-full text-left">
                           ...
                           <tbody className="divide-y text-[12px]">
                              <tr>
                                 ...
                                 <td className="py-2.5">
                                    <div className="flex items-center gap-2">
                                       ...
                                       <div>
                                          <p className="font-semibold text-gray-900 text-[11px]">World Health Day Post</p>
                                 ...
                                 <td className="py-2.5"><span className="text-[9px] font-semibold text-blue-600 bg-blue-50 px-2 py-1 rounded">Scheduled</span></td>
                                 <td className="py-2.5 text-right">
                                    <div className="flex items-center justify-end gap-1">
                                       <button className="text-[10px] font-semibold text-gray-600 border rounded px-2 py-1 hover:bg-gray-50">Edit</button>
                              ...
                              <tr>
                                 ...
                                 <td className="py-2.5">
                                    <div className="flex items-center gap-2">
                                       <div className="size-5 rounded bg-red-100 flex items-center justify-center shrink-0 text-red-600"><span className="text-[10px] font-semibold">T</span></div>
                                       <div>
                                          <p className="font-semibold text-gray-900 text-[11px]">Team Meeting Post</p>
                                 ...
                                 <td className="py-2.5 text-gray-600 text-[11px]">Moksha Sewa</td>
                                 <td className="py-2.5"><span className="text-[9px] font-semibold text-gray-600 bg-gray-100 px-2 py-1 rounded">Draft</span></td>
                                 <td className="py-2.5 text-right">
                                    <div className="flex items-center justify-end gap-1">
                                       <button className="text-[10px] font-semibold text-gray-600 border rounded px-2 py-1 hover:bg-gray-50">Edit</button>
                                       <button className="border rounded p-1 hover:bg-gray-50 text-gray-500"><MoreVertical className="size-3.5" /></button>
                              ...
                              <tr>
                                 ...
                                 <td className="py-2.5">
                                    <div className="flex items-center gap-2">
                                       <div className="size-5 rounded bg-red-100 flex items-center justify-center shrink-0 text-red-600"><span className="text-[10px] font-semibold">B</span></div>
                                       <div>
                                          <p className="font-semibold text-gray-900 text-[11px]">Behind the Scenes Story</p>
                  ...
                  <div className="space-y-3">
                     <div>
                        ...
                        <div className="relative">
                           <select className="w-full text-[12px] font-medium h-8 rounded-sm border border-gray-200 px-2.5 outline-none focus:border-gray-300 bg-white appearance-none"><option>Moksha Sewa</option></select>
                     ...
                     <div>
                        ...
                        <div className="relative">
                           <select className="w-full text-[12px] font-medium h-8 rounded-sm border border-gray-200 px-2.5 outline-none focus:border-gray-300 bg-white appearance-none"><option>All Channels</option></select>
                           <ChevronDown className="size-3 absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
                        </div>
                     </div>
                     <div>
                        ...
                        <div className="relative">
                           <select className="w-full text-[12px] font-medium h-8 rounded-sm border border-gray-200 px-2.5 outline-none focus:border-gray-300 bg-white appearance-none"><option>All Status</option></select>
                           <ChevronDown className="size-3 absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
                        </div>
                     </div>
                     <div>
                        ...
                        <div className="relative">
                           <select className="w-full text-[12px] font-medium h-8 rounded-sm border border-gray-200 px-2.5 outline-none focus:border-gray-300 bg-white appearance-none"><option>All Campaigns</option></select>
                           <ChevronDown className="size-3 absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
                        </div>
                     </div>
                  </div>
               ...
               <div className="bg-white rounded-xl border shadow-sm p-3">
                  ...
                  <div className="space-y-4">
                     <div className="flex items-start gap-3">
                        ...
                        <div>
                           <p className="text-[12px] font-semibold text-gray-900 leading-tight">Clean Ganga Drive Post</p>
                     ...
                     <div className="flex items-start gap-3">
                        ...
                        <div>
                           <p className="text-[12px] font-semibold text-gray-900 leading-tight">Instagram Reels</p>
                     ...
                     <div className="flex items-start gap-3">
                        ...
                        <div>
                           <p className="text-[12px] font-semibold text-gray-900 leading-tight">Case Study Post</p>
                     ...
                     <div className="flex items-start gap-3">
                        ...
                        <div>
                           <p className="text-[12px] font-semibold text-gray-900 leading-tight">Documentary Clip</p>
                     ...
                     <div className="flex items-start gap-3">
                        ...
                        <div>
                           <p className="text-[12px] font-semibold text-gray-900 leading-tight">Reminder: Event</p>
