      ...
      <div className="flex flex-wrap items-start justify-between gap-4 rounded-lg border border-[#DDE4ED] bg-white p-3 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <button className="flex h-8 items-center gap-2 rounded border border-[#DDE4ED] bg-white px-2.5 text-[9px] font-semibold text-[#38444D] shadow-sm hover:bg-[#FAFBFC]">
            ...
            <div className="text-left"><span className="block leading-tight">Last 30 days</span><span className="block text-[7px] font-normal text-[#71809D]">Mar 15, 2025 – Apr 14, 2025</span></div>
