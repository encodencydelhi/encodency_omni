...
export function ProjectDetailPage({ projectId }: { projectId: string }) {
  ...
  if (!project) return <div className="grid min-h-[420px] place-items-center rounded-xl border border-[#DDE4ED] bg-white text-center"><div><h1 className="text-lg font-bold text-[#172044]">Project not found</h1><Link href="/admin/Clients" className="mt-3 inline-flex text-sm font-semibold text-[#EB0711]">Back to Clients</Link></div></div>;

  return <div className="space-y-4">
    <Link href="/admin/Clients" className="inline-flex items-center gap-1.5 text-[10px] font-semibold text-[#667695] hover:text-[#EB0711]"><ArrowLeft className="size-3.5" />Back to Clients</Link>
