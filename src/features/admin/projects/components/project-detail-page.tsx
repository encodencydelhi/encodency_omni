      ...
      <section className="">
        <div className="flex flex-col gap-3 xl:flex-row xl:items-start">
          <div className="flex min-w-0 flex-1 items-start gap-4">
            <div className="flex h-[88px] w-[124px] shrink-0 items-center justify-center rounded-sm border border-[#e1e5eb] bg-white p-2 shadow-sm">
          ...
          <div className="flex shrink-0 gap-2">
            <button className="flex h-9 items-center gap-1.5 rounded-sm border border-[#dce3ed] bg-white px-3 text-[11px] font-semibold text-[#35415c]"><Pencil size={13} />Edit Client</button>
    ...
    <>
      ...
      <div className="mt-2.5 grid grid-cols-1 items-stretch gap-2.5 xl:grid-cols-[1.05fr_1.05fr_1fr]">
        ...
        <Panel title="Brand Snapshot" action="Edit">
          ...
          <div className="mt-2 flex items-center gap-4 rounded-sm border border-[#d5e8da] bg-[#f1faf4] px-5 py-4">
      ...
      <Panel title="" className="mt-2.5">
        <div className="mb-2 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="flex h-8 items-center gap-1.5 rounded-sm bg-[#5a32e4] px-3 text-[11px] font-semibold text-white"><Plus size={13} />Add Integration</button>
          </div>
        </div>
        <div className="overflow-x-auto">
...
function QuoteBox({ text }: { text: string }) {
  return <div className="rounded-sm bg-[#f4f0ff] px-3 py-2 text-[11px] font-semibold leading-[1.45] text-[#59647b]">“ {text} ”</div>;
}
