...
function ConnectedIntegration({ channel, name, account, synced }: { channel: string; name: string; account: string; synced: string }) {
  return (
    <div className="flex items-start gap-2.5 rounded-sm border border-[#E6E8F0] bg-white p-3">
      ...
      <div className="grid gap-x-5 gap-y-3 p-5 md:grid-cols-2">
        ...
        <Field label="Additional Website / Landing Page URLs" optional hint="Add any additional websites, subdomains or landing pages.">
          <div className="flex gap-2">
            ...
            <button className="flex h-[42px] shrink-0 items-center gap-1 rounded-sm border border-[#C7D2FE] bg-[#EEF2FF] px-2.5 text-[11px] font-semibold text-[#4F46E5] transition-colors hover:bg-[#E0E7FF]">
        ...
        <div className="grid gap-2.5 md:col-span-2 md:grid-cols-3">
          <div className="flex items-start justify-between gap-3 rounded-sm border border-[#E6E8F0] bg-white p-3">
            ...
            {IMPORT_METHODS.map(({ id, icon: Icon, title, caption }) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-2 rounded-sm border px-2.5 py-2.5 text-left transition-colors",
                ...
                >
                  ...
                  >
                    {active && <i className="block size-2 rounded-sm bg-[#4F46E5]" />}
                  </span>
