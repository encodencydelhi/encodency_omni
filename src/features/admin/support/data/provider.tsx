...
const tickets: AdminSupportTicket[] = [
  ...
  },
  {
    ...
    assignedStaffId: "staff-rahul",
    ownerName: "Rahul Sharma",
    sla: { id: "sla-1054", policy: "Standard Support SLA", firstResponseTarget: "4h", resolutionTarget: "24h", state: "Met", deadline: "Closed", firstResponseActual: "55m", resolutionRemaining: "Resolved" },
