...
export const MOCK_DRAFTS: ContentDraft[] = [
  {
    ...
    masterContent: {
      ...
      cta: "Learn More", ctaUrl: "https://mokshasewa.org/clean-ganga",
      hashtags: ["#CleanGanga", "#HealthyIndia", "#Sustainability", "#MokshaSewa"],
      mentions: [], media: MOCK_MEDIA.slice(0, 3), link: "https://mokshasewa.org/clean-ganga",
      location: "Varanasi, UP", altText: "", firstComment: "What small action will you take today? 💚",
      language: "English", tone: "Positive",
    },
    channels: ["instagram", "facebook", "linkedin"],
    platformOverrides: {},
    platformSchedules: [{ platform: "instagram", schedule: "later", date: "Sep 14, 2026", time: "11:00 AM" }],
    ratios: { instagram: "4:5" },
    customRatios: {},
    autoAdapt: { autoResize: true, smartCrop: true, preserveSubject: true, preserveLogo: false, preserveText: false, preserveFaces: false, respectSafeZones: true },
    variants: [],
    utm: { source: "instagram", medium: "social", campaign: "clean_ganga", content: "feed_01", term: "" },
    platformUtms: {},
    approvalStatus: "pending", approver: "Content Team",
    createdAt: "2026-09-04T08:30:00Z", updatedAt: "2026-09-04T14:14:00Z", createdBy: "Manish Sirohi",
  },
  {
    ...
    masterContent: {
      ...
      cta: "Join Us", ctaUrl: "https://mokshasewa.org/volunteer",
      hashtags: ["#Volunteer", "#ChangeMakers", "#MokshaSewa"],
      mentions: [], media: MOCK_MEDIA.slice(1, 3), link: "https://mokshasewa.org/volunteer",
      location: "", altText: "", firstComment: "",
      language: "English", tone: "Inspirational",
    },
    channels: ["instagram", "facebook", "youtube"],
    platformOverrides: {},
    platformSchedules: [],
    ratios: { instagram: "9:16" },
    customRatios: {},
    autoAdapt: { autoResize: true, smartCrop: true, preserveSubject: true, preserveLogo: false, preserveText: false, preserveFaces: false, respectSafeZones: true },
    variants: [],
    utm: { source: "", medium: "", campaign: "", content: "", term: "" },
    platformUtms: {},
    approvalStatus: "draft", approver: "Content Team",
    createdAt: "2026-09-03T10:00:00Z", updatedAt: "2026-09-03T17:40:00Z", createdBy: "Prateeksha",
  },
  {
    id: "d3", title: "Daily Motivation & Community Note",
    client: MOCK_CLIENTS[0]!, campaign: null,
    isStandalone: true,
    masterContent: {
      caption: "A simple reminder to support one another today and every day. #CommunityLove",
      headline: "Daily Community Reminder", description: "A regular uplifting message for our community.",
      cta: "Learn More", ctaUrl: "https://mokshasewa.org",
      hashtags: ["#MokshaSewa", "#CommunityLove", "#DailyMotivation"],
      mentions: [], media: MOCK_MEDIA.slice(2, 4), link: "https://mokshasewa.org",
      location: "", altText: "", firstComment: "",
      language: "English", tone: "Positive",
    },
    ...
    ratios: { linkedin: "1:1" },
    customRatios: {},
    autoAdapt: { autoResize: true, smartCrop: true, preserveSubject: false, preserveLogo: false, preserveText: false, preserveFaces: false, respectSafeZones: true },
    variants: [],
    utm: { source: "", medium: "", campaign: "", content: "", term: "" },
    platformUtms: {},
    approvalStatus: "approved", approver: "Content Team",
    createdAt: "2026-09-01T06:00:00Z", updatedAt: "2026-09-01T10:00:00Z", createdBy: "Ankit Kumar",
  },
  {
    ...
    masterContent: {
      ...
      cta: "Read More", ctaUrl: "",
      hashtags: ["#CleanIndia", "#Tips", "#EcoFriendly"],
      mentions: [], media: MOCK_MEDIA.slice(0, 1), link: "",
      location: "", altText: "", firstComment: "",
    ...
    platformUtms: {},
    approvalStatus: "draft", approver: "Content Team",
    createdAt: "2026-08-28T07:30:00Z", updatedAt: "2026-08-28T12:30:00Z", createdBy: "Neha Sharma",
  },
  {
    id: "d5", title: "Weekend Greeting & Open Q&A (Direct Post)",
    client: MOCK_CLIENTS[2]!, campaign: null,
    isStandalone: true,
    masterContent: {
      caption: "Wishing everyone a peaceful weekend! Ask us any questions about our upcoming activities below.",
      headline: "Weekend Greetings", description: "Direct weekend update without campaign association.",
      cta: "Comment Below", ctaUrl: "",
      hashtags: ["#WeekendVibes", "#OpenQA", "#MokshaSewa"],
      mentions: [], media: MOCK_MEDIA.slice(3, 4), link: "",
      location: "", altText: "", firstComment: "",
      language: "English", tone: "Playful",
    },
    channels: ["instagram"],
    platformOverrides: {},
    platformSchedules: [],
    ...
    platformUtms: {},
    approvalStatus: "draft", approver: "Content Team",
    createdAt: "2026-08-26T09:15:00Z", updatedAt: "2026-08-26T16:15:00Z", createdBy: "Manish Sirohi",
  },
];
...
export const MOCK_APPROVALS: ApprovalEntry[] = [
  { id: "a1", title: "Cleaner Rivers, Brighter Tomorrow", channel: "instagram", client: "Moksha Sewa", campaign: "Clean Ganga Awareness", owner: "Manish Sirohi", submittedBy: "Manish Sirohi", submittedAt: "Sep 4, 2026", status: "pending", image: IMG.river },
  { id: "a2", title: "Behind the Scenes", channel: "facebook", client: "Namo Gange Trust", campaign: "Volunteer Drive 2026", owner: "Prateeksha", submittedBy: "Prateeksha", submittedAt: "Sep 3, 2026", status: "approved", image: IMG.cleanup },
  { id: "a3", title: "Small Actions, Big Change", channel: "linkedin", client: "Moksha Sewa", campaign: null, owner: "Ankit Kumar", submittedBy: "Ankit Kumar", submittedAt: "Sep 2, 2026", status: "changes-requested", image: IMG.water },
  { id: "a4", title: "World Environment Day", channel: "youtube", client: "Ganga Explorer", campaign: "River Conservation Tips", owner: "Ritu Pandey", submittedBy: "Ritu Pandey", submittedAt: "Aug 30, 2026", status: "pending", image: IMG.nature },
  { id: "a5", title: "Tips for a Cleaner India", channel: "whatsapp", client: "Namo Gange Foundation", campaign: "River Conservation Tips", owner: "Neha Sharma", submittedBy: "Neha Sharma", submittedAt: "Aug 29, 2026", status: "approved", image: IMG.water },
  { id: "a6", title: "Save Water Save Life", channel: "instagram", client: "Moksha Sewa", campaign: null, owner: "Manish Sirohi", submittedBy: "Manish Sirohi", submittedAt: "Aug 26, 2026", status: "pending", image: IMG.water },
  { id: "a7", title: "Festival Greetings", channel: "google-business", client: "Namo Gange Trust", campaign: null, owner: "Prateeksha", submittedBy: "Prateeksha", submittedAt: "Aug 24, 2026", status: "approved", image: IMG.lake },
  { id: "a8", title: "Join Our Mission", channel: "website", client: "Moksha Sewa", campaign: "Donate for Change", owner: "Ankit Kumar", submittedBy: "Ankit Kumar", submittedAt: "Aug 22, 2026", status: "changes-requested", image: IMG.people },
];
