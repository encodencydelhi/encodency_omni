...
export function IdeasTab() {
  ...
  return (
    <div className="grid items-start gap-3 xl:grid-cols-[minmax(0,1fr)_320px]">
      <Card title="Content ideas" subtitle="Curated prompts for your next post" action={<button className="flex h-8 items-center gap-1.5 rounded-lg bg-purple-50 px-3 text-[11.5px] font-semibold text-purple-700 ring-1 ring-purple-200 hover:bg-purple-100"><Sparkles className="size-3.5" /> Generate with AI</button>}>
      ...
      <Card title="Idea details" className="xl:sticky xl:top-4">
        ...
        <button className="mt-2.5 h-9 w-full rounded-lg bg-[#EB0711] text-[12px] font-semibold text-white transition hover:bg-[#D60811]">Use this idea</button>
        <button className="mt-1.5 h-8 w-full rounded-lg border text-[11.5px] font-semibold text-[#687797] hover:bg-slate-50">Customize with AI</button>
      </Card>
    </div>
  );
}