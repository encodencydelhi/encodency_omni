...
const MAINTENANCE: GlobalSettingDefinition[] = [
  ...
  build("maintenance", { key: M("announcement.starts_at"), name: "Planned start", description: "When the maintenance window begins (UTC).", group: "announcement", valueType: "datetime", defaultValue: "2026-09-11T20:30:00.000Z", required: true, timing: "on_schedule" }),
  build("maintenance", { key: M("announcement.ends_at"), name: "Planned end", description: "When the maintenance window ends (UTC).", group: "announcement", valueType: "datetime", defaultValue: "2026-09-11T22:30:00.000Z", required: true, timing: "on_schedule" }),
  ...
  build("maintenance", { key: M("access.starts_at"), name: "Restriction start", description: "When the restriction begins (UTC).", group: "access", valueType: "datetime", defaultValue: "2026-09-11T20:30:00.000Z", sensitivity: "high", ...platform }),
  build("maintenance", { key: M("access.ends_at"), name: "Restriction end", description: "When the restriction ends (UTC).", group: "access", valueType: "datetime", defaultValue: "2026-09-11T22:30:00.000Z", sensitivity: "high", ...platform }),
