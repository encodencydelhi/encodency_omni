  ...
  return (
    <div className="space-y-4 w-full min-w-0 max-w-7xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
        {[
          { label: "COMPANIES", value: COMPANY_POOL_EXPORT.length, color: "text-blue-700" },
          { label: "COMPLETE", value: completeCount, color: "text-emerald-700" },
          { label: "UNASSIGNED", value: unassignedCount, color: unassignedCount > 0 ? "text-rose-700" : "text-slate-600" },
          { label: "NO BACKUP", value: missingBackupCount, color: "text-amber-700" },
          { label: "STAFF ASSIGNED", value: staffWithAssignments, color: "text-violet-700" },
          { label: "NEED REASSIGN", value: 0, color: "text-slate-600" },
        ].map((k) => (
