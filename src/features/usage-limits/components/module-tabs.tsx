...
/**
 * The compact module navigation shared by every Usage & Limits route. Each tab is
 * a real URL, so refresh, Back and Forward land where they were, and the parent
 * sidebar item stays active throughout.
 */
export function ModuleFrame({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="space-y-3">
      <nav aria-label="Usage and limits" className="overflow-x-auto border-b border-border scrollbar-thin">
