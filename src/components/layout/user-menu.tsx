...
import { ChevronsUpDownIcon, KeyRoundIcon, LifeBuoyIcon, LogOutIcon, SettingsIcon, UserIcon } from "lucide-react";
...
import { ReplaceTotpDialog } from "@/features/auth/components/replace-totp-dialog";
...
export function UserMenu() {
  ...
  const [replaceTotpOpen, setReplaceTotpOpen] = useState(false);
  if (!user) return null;
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-64">
          ...
          <DropdownMenuItem onSelect={() => setReplaceTotpOpen(true)}>
            <KeyRoundIcon />
      ...
      <ReplaceTotpDialog open={replaceTotpOpen} onOpenChange={setReplaceTotpOpen} />
    </>
  );
}
